...
log_print "--- Step 2: Discovering the latest matching snapshot ---"
...
log_print "Matched Snapshot Name:   $SNAPSHOT_NAME"
log_print "Matched Snapshot ID:     $SOURCE_SNAPSHOT_ID"
log_print ""
